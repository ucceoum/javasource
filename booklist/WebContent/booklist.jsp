<%@ page import="java.sql.*" language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR"%>
...
<%
	...
	Connection dbconn = DriverManager.getConnection(url, "madang", "12345");
...
<table cellpadding = "0" cellspacing = "0" width = "400" height="23">
	<tr>
		<td width = "1350">
			...
			<font size = "1" face = "돋움체" color = "black">LIST
			</font></a></b></p>
		</td>
	</tr>
</table>

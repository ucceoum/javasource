...
public class CheckingTrafficCardAccountEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("현재 잔액 : "+traffic.getBalance());
		
		
		//출금하다
		try {
			traffic.withdraw(300000);
			System.out.println("출금 후 현재 잔액 : "+traffic.getBalance());
			//직불카드 사용액을 지불한다.
			
			traffic.pay("5469-4568-7235-7123",100000);
			System.out.println("직불카드 사용 후 현재 잔액 : "+traffic.getBalance());
			
			//교통카드 사용액을 지불한다.
			traffic.payTrafficCard("5469-4568-7235-7123", 2300);
			System.out.println("교통카드 사용 후 현재 잔액 : "+traffic.getBalance());

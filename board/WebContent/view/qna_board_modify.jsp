		...
		<form action="qUpdate.do" method="post" enctype="multipart/form-data" role="form" id="writeForm">
			<div class="box-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea name='content' cols='60' class="form-control" rows='15' id="content">${vo.content}</textarea>
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="box-footer text-center">
					...
					<button type="button" class="btn btn-danger" onclick="location.href='qList.do?page=<%=request.getParameter("page")%>'">취소</button>
				</div>
				<div style="height:20px"></div>
			</div>
